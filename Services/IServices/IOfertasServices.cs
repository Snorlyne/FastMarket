...
namespace Services.IServices
{
    public interface IOfertasServices
    {
        ...
        Task<Response<OfertasCreateDto>> CrearEditarOferta(int idPersona, int idAnuncio, OfertasCreateDto request, List<ProductosDto> productos);
        ...
        Task<Response<object>> ObtenerOfertasPorAnuncio(int idPersona, int idAnuncio);
