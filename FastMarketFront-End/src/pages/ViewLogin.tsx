    ...
    return (
        ...
        >
            <Container maxWidth="sm">
                <Paper elevation={3} sx={{ padding: 4, borderRadius: '15px', overflow: 'hidden' }}>
                    <Box
                        display="flex"
                    ...
                    >
                        ...
                        <Typography variant="subtitle1" gutterBottom>
                            Bienvenido a una aplicación de subasta!
                        </Typography>
                        ...
                        <Typography className='p' sx={{ mt: 2 }}>
                            ¿No tienes cuenta? 
                            <span 
                                onClick={() => history.push('/ViewRegister')} 
                                className='span'>
                                Regístrate
                            </span>
                        </Typography>
