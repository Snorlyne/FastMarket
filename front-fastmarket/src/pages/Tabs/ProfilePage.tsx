...
const ProfilePage:React.FC = () => {
  ...
  return (
    <div className="p-4 bg-white h-screen">
      ...
      <IonCard className="bg-white shadow-lg rounded-lg max-w-sm"  onClick={() =>  history.push("/ViewProfile")}
      >
      <IonCardHeader>
  ...
  <IonCard className="w-44 rounded-xl" onClick={() => history.push("/ViewMySale")}>
    <IonCardHeader>
  ...
  <IonCard className="w-44 rounded-xl">
    <IonCardHeader>
      ...
      <div className="mt-6">
        <button className="w-full bg-red-500 text-white py-2 rounded-lg hover:bg-red-600 transition flex justify-center"   onClick={() => !isLoading && history.push("/login")}>
