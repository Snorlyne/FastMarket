...
const [messages, setMessages] = useState([
    { sender: 'Tú', text: 'Hola a todos, bienvenidos a nuestra subasta de hoy. Tenemos un maravilloso reloj antiguo para subastar. La puja inicial comienza en $100. ¿Algún interesado en comenzar la oferta?' },
    { sender: 'Cliente 1', text: '¡Yo! Ofrezco $120 por el reloj.' },
    { sender: 'Cliente 2', text: 'Subo la oferta a $150.' },
    { sender: 'Tú', text: 'Gracias, Cliente 2. Tenemos una oferta de $150. ¿Alguien más quiere mejorar la oferta?' },
]);

const [newMessage, setNewMessage] = useState('');

const userColors: { [key: string]: string } = {
    'Tú': 'bg-indigo-100 text-indigo-700',
